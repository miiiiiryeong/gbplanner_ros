...
class Gbplanner {
 ...
 private:
  ...
  // ADD traversability map subscriber & gridmap param & traversability map flag : Miryeong
  ros::Subscriber traversability_map_sub;
  ...
  void traversabilityCallback(const grid_map_msgs::GridMap& msg);
